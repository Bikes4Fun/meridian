---
name: Combined infrastructure and security tests
overview: GitHub-issue-ready test plan — security first, infrastructure with persistence; deprioritize feature tests; fix conftest and run method.
todos: []
isProject: false
---
