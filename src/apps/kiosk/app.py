...
class KioskBridge:
    ...
    def fetch_url_b64(self, url: str) -> str:
        """Fetch authenticated URL and return raw bytes as base64 for PDF.js canvas rendering."""
        import base64
        ...
        try:
            ...
            logger.warning(f"fetch_url_b64 failed: {e}")
            return ""
