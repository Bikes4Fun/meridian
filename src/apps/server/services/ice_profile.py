...
class ICEProfileService(DatabaseServiceMixin):
    ...
    def get_ice_profile(self, user_id: str) -> ServiceResult:
        ...
        allergies_result = self.safe_query(
            "SELECT allergen FROM allergies WHERE user_id = ?", (user_id,)
        )
        allergies = (
    ...
    def update_ice_profile(self, user_id: str, data: dict) -> ServiceResult:
        ...
        if not result.success:
            return result
        return self.get_ice_profile(user_id)
