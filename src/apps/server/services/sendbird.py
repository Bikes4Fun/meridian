...
class SendbirdService(DatabaseServiceMixin):
    ...
    def is_configured(self) -> bool:
        ...
        return bool(self.get_sendbird_app_id() and self.get_sendbird_api_token())

    def get_sendbird_user_id_from_env(self, app_user_id: str) -> str:
        """
    ...
    def get_sendbird_default_recipient_id_from_env(self) -> str:
    ...
    def get_default_recipient(self, family_circle_id: str) -> tuple:
    ...
    def _headers(self) -> dict:
        ...
        return {
            "Api-Token": self.get_sendbird_api_token(),
